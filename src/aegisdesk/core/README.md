...
- **`web_tools.py`**: The headless BeautifulSoup4 scraper. Employs Pre-flight DNS validation (`DNSPinnedAdapter`) to permanently block Server-Side Request Forgery (SSRF) against internal VPC topologies (10.0.x.x, 169.254.x.x).\n